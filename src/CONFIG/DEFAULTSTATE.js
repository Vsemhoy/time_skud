...
export const DS_RULE_TYPES = [
    {
        ...
        "variable_b" : "Можно ли отрабатывать это потерянное время в день опоздания после конца установленного рабочего дня.",
    },
    {
        "id": 2,
        "name": "Переработка",
        ...
        "deleted" : 0,
        "variable_a" : "Разрешено приходить раньше на указанное время и уходить позже, то есть сдвигать начало и конец рабочего дня",
        "variable_b" : "Разрешено приходить позже и уходить уходить позже на указанное время",
    },
    {
        "id": 3,
        "name": "Перекуры",
        "description": "Правило, разрешающее пользователю выходить на перекуры и определяющее, можно ли это время отработать после",
        "deleted" : 0,
        "variable_a" : "Можно ли выходить на перекуры вообще",
        "variable_b" : "Можно ли отработать ",
    },
    {
        "id": 4,
        "name": "Глобальная отработка ПВ",
        "description": "Правило, разрешающее пользователю приходить раньше или уходить позже, чтобы уменьшить глобальное ПВ",
        "deleted" : 0,
        "variable_a" : "Можно приходить раньше начала установленного рабочего дня, это время будет вычтено из потерянного времени",
        "variable_b" : "Можно уходить позже конца установленного рабочего дня, это время будет вычтено из потерянного времени",
    },
    {
        "id": 5,
        ...
        "deleted" : 0,
        "variable_a" : "Можно приходить раньше начала установленного рабочего дня. Это время будет засчитано в накопительной системе.",
        "variable_b" : "Можно уходить позже конца установленного рабочего дня. Это время будет засчитано накопительной системой.",
    },
];
