...
export const DS_RULE_TYPES = [
    ...
    },
    {
        "id": 2,
        "name": "Переработка",
        "description": "Правило, разрешающее пользователю приходить раньше и уходить раньше, или приходить позже и уходить позже в границах t1, то есть сдвигать начало и конец рабочего дня на t1",
        "deleted" : 0,
        "id_company" :1,  
    },
    {
    ...
    {
        "id": 5,
        "name": "Правило, разрешающее пользователю приходить раньше или уходить позже, чтобы накапливать время, превышающее длительность РД про запас",
        "description": "",
        "deleted" : 0,
        "id_company" :1,  
    },
