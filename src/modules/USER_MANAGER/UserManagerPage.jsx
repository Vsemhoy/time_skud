...
import { DS_DEFAULT_USERS, DS_GROUP_USERS, DS_RULE_TYPES, DS_RULES, DS_SCHED_TYPES, DS_SCHED_TYPES_DB, DS_SCHEDULE_ENTITIES, DS_SCHEDULE_LIST, DS_SKUD_GROUPS, DS_USER } from "../../CONFIG/DEFAULTSTATE";
...
const UserManagerPage = (props) => {
   ...
   /**
     ...
     */
        ...
        try {
            let response = await PROD_AXIOS_INSTANCE.post(`${ROUTE_PREFIX}/timeskud/usermanager/schedtyplist?_token=` + CSRF_TOKEN);
    ...
    const get_ruleTypes = async (req, res) => {
        try {
            let response = await PROD_AXIOS_INSTANCE.post(`${ROUTE_PREFIX}/timeskud/usermanager/ruletyplist`, 
              {
                  data: {
                    deleted: 0
                  },
     ...
     */
        const get_userList = async (req, res) => {
            try {
                let response = await PROD_AXIOS_INSTANCE.post(`${ROUTE_PREFIX}/timeskud/usermanager/users`, 
                    {
                        data: {
                        id_company: null,
                        status: '0',
