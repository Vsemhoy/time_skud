...
const StateContainerIcon = ({ height = '100%' }) => (
  <svg
    ...
    xmlSpace="preserve"
    style={{ enableBackground: 'new 0 0 511.987 511.987' }}
    width={height}
    height={height}
  >
    ...
    {/* Gray container details */}
    <g>
      <polygon 
        fill="#E6E9ED" 
        points="261.291,216.018 237.932,220.8 220.089,204.987 196.715,209.768 178.872,193.941 
        205.058,99.866 287.478,121.959" 
      />
      <path 
        fill="#8594a8ff" 
        d="M511.987,10.665c0-5.891-4.781-10.656-10.671-10.656c-2.328,0-4.484,0.75-6.234,2.016h-0.016
      ...
      <path 
        fill="#8594a8ff" 
        d="M13.424,358.022c-5.688-1.516-11.531,1.859-13.062,7.546c-1.515,5.688,1.859,11.547,7.547,13.062
    ...
    <path 
      fill="#434A54" 
      d="M247.386,431.394c-9.141,34.141,11.124,69.232,45.265,78.389
    ...
    {/* Light gray wheel detail */}
    <path 
      fill="#E6E9ED" 
      d="M330.055,453.91c-3.047,11.375-14.749,18.141-26.124,15.078
...
export default StateContainerIcon;